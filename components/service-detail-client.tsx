...
export default function ServiceDetailClient({ id }: { id: string }) {
	...
	const handleBooking = () => {
		...
		alert(
			`Réservation confirmée pour le ${format(
				date,
				'dd/MM/yyyy'
			)} à ${selectedTimeSlot}`
		);
