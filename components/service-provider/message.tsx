...
export default function ServiceProviderMessage() {
	...
	} = useApiCall(() => serviceProviderService.getConversations());
						...
						conv.messages?.map((msg: any) => ({
							...
							senderName:
								msg.sender?.firstName +
									' ' +
									msg.sender?.lastName || 'Utilisateur',
							content: msg.content,
							timestamp: msg.created_at,
							isRead: msg.is_read || false,
							isFromUser:
								msg.sender_id.toString() ===
								conv.current_user_id?.toString(),
						})) || [],
				}));
		...
		if (
					...
					messages: [
						{
							...
							senderName: 'Thomas',
							content:
								"Bonjour! J'aurais besoin de votre service.",
				...
				},
				{
					...
					messages: [
						...
						},
						{
							...
							senderName: 'Lucas',
							content:
								"I'll be at the storage box in about an hour.",
			...
			const handleSendMessage = async () => {
				...
				try {
					...
					const response = await serviceProviderService.sendMessage(
						messageData
					);
